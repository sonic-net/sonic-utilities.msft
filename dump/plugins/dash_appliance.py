...
class Dash_Appliance(Executor):
    ...
    def execute(self, params):
        ...
        self.init_dash_app_table_appl_info(dash_app_table_name)
        return self.ret_temp

    def init_dash_app_table_appl_info(self, dash_app_table_name):
        req = MatchRequest(db="APPL_DB", table="DASH_APPLIANCE_TABLE", key_pattern=dash_app_table_name, ns=self.ns)
        ret = self.match_engine.fetch(req)
